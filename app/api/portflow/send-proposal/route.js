...
// POST /api/portflow/send-proposal — send a proposal email to client
export async function POST(request) {
  ...
  // Fetch the proposal with client data
  ...
  const baseUrl =
    ...
    "http://localhost:5000";
  const portalUrl = `${baseUrl}/portal/proposals/${proposal.magic_token}`;
  ...
  const summary =
    proposal.content?.executive_summary?.substring(0, 300) || "";
